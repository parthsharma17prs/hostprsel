        ...
        <>
            <style>{`
                @keyframes whatsapp-pulse {
                    0% { box-shadow: 0 0 0 0 rgba(240, 235, 216, 0.5); }
                    70% { box-shadow: 0 0 0 14px rgba(240, 235, 216, 0); }
            ...
            <a
                ...
                className="whatsapp-btn fixed bottom-6 right-6 z-50 bg-[#0d1b2a] hover:bg-[#1a2d42] text-[#f0ebd8] border-2 border-[#f0ebd8] rounded-full w-14 h-14 flex items-center justify-center shadow-lg hover:scale-110 transition-transform duration-300"
            >
                <svg
